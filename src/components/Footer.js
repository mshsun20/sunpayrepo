        ...
        <div className="footr">
            <footer className="container ">
                ...
                <div className="fotrsocm">
                    <div className="ftrshdr">👍 follow us 👍</div>
                    <div className="ftrscnt">
                ...
                <hr />
                <div className="fotrebl">
                    <small className="d-block mb-3 text-muted"><span className="febl">&copy;CopyRights Protected By Sunny Halder 2017–2021</span></small>
                </div>
            </footer>
        </div>
        </>
